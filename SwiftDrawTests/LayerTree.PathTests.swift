...
final class LayerTreePathTests: XCTestCase {
    ...
    func testDirectionInverts() {
        XCTAssertEqual(!LayerTree.Path.Direction.anticlockwise, .clockwise)
        XCTAssertEqual(!LayerTree.Path.Direction.clockwise, .anticlockwise)
    }

    func testClockwiseDirection() {
        let segments: [LayerTree.Path.Segment] = [
            .move(to: Point(10, 10)),
            .line(to: Point(15, 15)),
            .line(to: Point(10, 20)),
            .line(to: Point(5, 10)),
        ...
        XCTAssertEqual(segments.direction, .clockwise)
    }

    func testAnticlockwiseDirection() {
        let segments: [LayerTree.Path.Segment] = [
            .move(to: Point(10, 10)),
            .line(to: Point(5, 10)),
            .line(to: Point(10, 20)),
        ...
        XCTAssertEqual(segments.direction, .anticlockwise)
    }
